...
(() => {
    ...
    addEventListener("fetch", async (event) => {
      event.respondWith(async function() {
        ...
        function setupCORSHeaders(headers, originHeader) {
          // Use the actual Origin header instead of "*"
          headers.set("Access-Control-Allow-Origin", originHeader || "*");
          headers.set("Vary", "Origin"); // Add Vary header to handle caching based on Origin
          headers.set("Access-Control-Allow-Credentials", "true"); // Allow credentials if needed
